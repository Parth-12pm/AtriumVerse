      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Experience collaboration the way it should be — spontaneous,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-primary/10 border-4 border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Video calls that feel natural. Walk up to colleagues to start a
                conversation, walk away to end it.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-accent/10 border-4 border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                See who&apos;s around, who&apos;s busy, and who&apos;s
                available. Build team culture remotely.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-secondary border-4 border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                No more scheduling. Just walk into a meeting room and your video
      ...
      <section className="container mx-auto px-4 py-20 border-t-4 border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Set up your virtual office in seconds. Choose a template or
              customize your own.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Share a link and let your teammates join. Everyone gets their own
              avatar.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Walk around, meet people, join conversations. It&apos;s that
              simple.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20 border-t-4 border-border">
        <Card className="bg-primary border-4 border-border p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-xl mx-auto">
            Join thousands of teams already using AtriumVerse for better remote
            collaboration.
          </p>
          <Link href="/register">
            <Button
